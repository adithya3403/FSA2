...
public class d45p1 {
    public static void main(String[] args) {
        ...
        System.out.println(findProfit(customers, boardingCost, runningCost));
        sc.close();
    }

    static int findProfit(int[] customers, int boardingCost, int runningCost) {
        int sum = 0, c = 0, profit = 0;
        for (int i : customers) {
            sum += i;
            if (sum >= 4) {
